 $(document).ready(function () {
    ...
    $('#link-cadastrar').click(function () {
        $('#conteudo').load('/projeto-pessoa-json/cadastrar.html', funcoesCadastrar);
    });

    $('#link-listar').click(function () {
        $('#conteudo').load('/projeto-pessoa-json/listar.html', funcoesListar);
    });
...
var funcoesCadastrar = function () {
    ...
    $('#btn-salvar').click(function () {
        ...
        var opcoes = {
            url: 'http://localhost:8080/projeto-pessoa-json/cadastrar.html',
            method: 'POST',
            dataType: 'JSON',
...
var funcoesListar = function () {
    ...
    $('#tabela-pessoa').on('click', '.excluir', function () {
        ...
        $.ajax({
            url: 'http://localhost:8080/projeto-pessoa-json/pessoa' + cpf,
            method: 'DELETE',
            success: function (resposta) {
                if (resposta.sucesso) {
                    carregarTabela();
